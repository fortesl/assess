...
export const routes: Route[] = [
  ...
  { path: 'admin/questions/create/:first', component: CreateQuestionsComponent, canActivate: [AuthGuard, AdminAuthGuard] },
  { path: 'admin/questions/create/:last', component: CreateQuestionsComponent, canActivate: [AuthGuard, AdminAuthGuard] },
